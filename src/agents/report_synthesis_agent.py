...
def create_pdf_stream(input_data: Dict[str,Any]) -> bytes:
    ...
    """
    # Import lazily so CLI/API startup does not require native PDF libraries.
    import weasyprint

    template_path = os.path.join(
        os.path.dirname(os.path.dirname(__file__)), "utils", "report_template.html"
    )
    ...
    pdf_bytes = weasy_html.write_pdf(
        ...
        pdf_metadata={
            ...
            'creator': 'MarketScout Research Platform',
            'producer': 'MarketScout',
