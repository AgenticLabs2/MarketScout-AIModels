...
def run_company_research_agent(company_name: str) -> Dict[str, Any]:
    ...
    """
    try:
        company_data, raw = run_structured_agent(
            system_prompt=SYSTEM_PROMPT,
            user_prompt=f"Research and provide information about {company_name}",
            response_model=Company,
            use_search=True,
        )
        return {"success": True, "data": company_data, "raw_response": raw}
